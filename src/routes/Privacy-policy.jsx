  ...
  return (
    <>
      ...
      <div className="container pt-5 mt-5">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Abderazak Amiar Portfolio.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Abderazak Amiar Portfolio,
              accessible from{" "}
              <a
                href="https://abderazakamiar.com"
        ...
        <ul>
          <li>
            <p>By email: abderazakamiar@gmail.com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="https://abderazakamiar.com/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://abderazakamiar.com/contact
              </a>
            </p>
          </li>
        </ul>
